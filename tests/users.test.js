...
describe('Users API', () => {
  ...
  describe('GET /api/v1/users/:id', () => {
    it('should return a user by ID', async () => {
      ...
      const createResponse = await request(app).post('/api/v1/users').send(userData);
  ...
  describe('PUT /api/v1/users/:id', () => {
    it('should update a user', async () => {
      ...
      const updateResponse = await request(app).put(`/api/v1/users/${userId}`).send(updateData);
  ...
  describe('DELETE /api/v1/users/:id', () => {
    it('should delete a user', async () => {
      ...
      const deleteResponse = await request(app).delete(`/api/v1/users/${userId}`);
